...
const displayController = (() => {
    ...
    const draw_scores = (player_score,tie_score,computer_score) => {
        ...
        const tie_p = document.getElementById('tie-score');
        tie_p.innerHTML = `${tie_score}`;
    }
...
const gameController = (() => {
    ...
    const game_is_played = (player, row, column) => {
        ...
        displayController.draw_scores(player_score,tie,computer_score);
    }

    return {player_marker,computer_marker,game_is_played};
})();
